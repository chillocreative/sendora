        ...
        <section class="pt-32 sm:pt-40 pb-16 sm:pb-20 px-4">
            <div class="max-w-7xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                    ...
                    <a href="https://wa.me/60148885659?text=Hi%2C%20I%27d%20like%20a%20demo%20of%20Sendora" target="_blank" rel="noopener" class="w-full sm:w-auto bg-slate-900 text-white px-8 sm:px-12 py-4 sm:py-5 rounded-2xl text-base sm:text-xl font-bold flex items-center justify-center gap-3">
