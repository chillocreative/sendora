    ...
    <div class="min-h-screen bg-white text-slate-900 font-sans selection:bg-red-100 selection:text-[#780116] overflow-x-hidden relative">
            ...
            <nav class="flex-1 px-4 py-8 space-y-2 overflow-y-auto">
                ...
                <template v-if="canLogin">
                    ...
                    <template v-else>
                        ...
                        <Link v-if="canRegister" :href="route('register')" class="flex items-center px-4 py-4 text-sm font-bold rounded-xl bg-[#780116] text-white hover:bg-[#c32f27]" @click="showMobileMenu = false">Start Free Trial</Link>
                    </template>
                </template>
            </nav>
        </div>
        ...
        <section class="pt-32 sm:pt-40 pb-16 sm:pb-20 px-4">
            <div class="max-w-7xl mx-auto text-center">
                <!-- Two pillars badge -->
                <div class="inline-flex items-center gap-3 px-4 py-2 bg-slate-900 rounded-full mb-8">
                    <span class="flex items-center gap-1.5 text-[#f7b538] text-xs font-black uppercase tracking-widest">
                    ...
                    <span class="flex items-center gap-1.5 text-emerald-400 text-xs font-black uppercase tracking-widest">
        ...
        <section class="py-16 sm:py-24 bg-white px-4">
            <div class="max-w-5xl mx-auto rounded-[2rem] sm:rounded-[3rem] bg-slate-900 p-8 sm:p-12 md:p-20 text-center relative overflow-hidden">
                ...
                <p class="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto mb-8 sm:mb-10">
                    Set up your first campaign or AI Playbook in under 15 minutes. No credit card required.
                </p>
