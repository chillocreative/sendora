                                    ...
                                    <div class="bg-slate-900 rounded-xl p-4 mb-4 ml-1 flex items-center justify-between gap-4">
                                        ...
                                        <div class="flex items-center gap-2 flex-shrink-0">
                                            <button
                                                ...
                                                :title="token.has_encrypted_token ? 'Copy actual token to clipboard' : 'This is a legacy token - copy not available'"
                                            >
                                            ...
                                            <div v-if="token.has_encrypted_token" class="px-3 py-1 bg-green-500/10 text-green-400 rounded-lg text-[9px] font-black uppercase tracking-wider">Copyable</div>
                                            <div v-else class="px-3 py-1 bg-red-500/10 text-red-400 rounded-lg text-[9px] font-black uppercase tracking-wider">Legacy</div>
                                        </div>
                                    </div>
