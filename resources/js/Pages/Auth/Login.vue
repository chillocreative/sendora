    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-between mt-8">
                <Link v-if="canResetPassword" :href="route('password.request')" class="text-[11px] font-black uppercase tracking-widest text-slate-400 hover:text-[#780116] transition-colors">
                    Reset Password?
                </Link>
